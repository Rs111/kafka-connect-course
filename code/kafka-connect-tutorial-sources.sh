...
# the below is wrong; should be execing; we are basically starting a whole new container here by using run
# Linux / Mac
...
# create the topic we write to with 3 partitions; can verify in web that additional topic was created
...
# connector takes data from demo-file.txt and puts it into a kafka topic
# you can add values to file and save; they will appear in topic
# standalone.offsets file gets created after you do this
